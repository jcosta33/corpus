...
*launch*, and *reconcile* agent runs — each useful standalone, all composed by the Corpus workspace
...
4. **The canonical adapter event contract.** Adopt the converged vocabulary
   ...
   (resolves RFC Q-001). Corpus invents no new event vocabulary. *Level: toolable.*
