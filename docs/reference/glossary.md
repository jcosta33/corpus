...
| **evolvability defect**       | A maintainability/readability/structure/documentation issue that does not affect visible behavior — the layer tests cannot reach and review primarily catches (~75% of review findings; ADR-0095).                          |
